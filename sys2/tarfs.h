...
void *readelf(char *file);
void loadUser(struct task_struct *,char * ,char **);
void contextswtch(struct task_struct *curr,struct task_struct *prev);
void loadChild(struct task_struct *pcb,char *file,char *argv[] );
void context_switch(struct task_struct *next, struct task_struct *prev);
void switchtochild(struct task_struct *pcb,struct task_struct *);
void contextswitch(registers *,registers *,struct task_struct *,uint64_t);
